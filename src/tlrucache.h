...
//typedef std::tuple<std::string, std::string, std::chrono::time_point<std::chrono::steady_clock>> Tuple;
//typedef std::list<Tuple>::iterator TupleIterator;

class TLRUCache : public Mere::Cache::Cache
{
public:
    ~TLRUCache();
